...
def forced_align(ctc_probs: torch.Tensor,
    ...
    # 画图
    # log_alpha=log_alpha.transpose(0,1)
    # print("log_alpha[0]")
    # print(log_alpha[0])
    # print("log_alpha[1]")
    # print(log_alpha[1])
    ...
    # print("ctc_probs[:][0]")
    # print(ctc_probs[0])
    # print("ctc_probs[:][target[0]]")
    # print(ctc_probs[y[0]])
    # print("ctc_probs[:][target[1]]")
    # print(ctc_probs[y[1]])


    # plt.imshow(log_alpha, cmap='hot', interpolation='nearest')
    # plt.colorbar()
    # pic_path="../../1.png"
    # plt.savefig(pic_path)
    # plt.plot(ctc_probs[0], linestyle='-', color='red', label='blank')
    # plt.plot(ctc_probs[y[0]], linestyle='-', color='blue', label='0')
    # plt.plot(ctc_probs[y[1]], linestyle='-', color='yellow', label='1')
    # plt.xlabel('x')
    # plt.ylabel('y')
